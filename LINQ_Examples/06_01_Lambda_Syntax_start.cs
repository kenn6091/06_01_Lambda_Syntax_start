...
namespace LINQ_Examples
{
    class Program
    {
        ...
        static void Main(string[] args) {
            ...
            Console.WriteLine();
            foreach (double d in ExchangedPrices) {
                if (d<1000.00) {
                    Console.WriteLine(d);
                }
            }
            ...
            foreach (Customer c in customers) {
                if (c.State == "GA") {
                    Console.WriteLine("Name: " + c.First + " " + c.Last + ", State: " + c.State);
            ...
            Console.WriteLine();
            foreach (Customer c in customers) {
                string FullName = c.First + " " + c.Last;
            ...
            Console.WriteLine();
            List<string> States = new List<string> {"List: "};
            bool exists = true;
            foreach (Customer c in customers) {
            ...
            exists = true;
            foreach (Distributor c in distributors) {
                foreach (string s in States) {
                    if (c.State != s) {
                        exists = false;
                    } else {
